...
# accessibility [accom]
  * aka a11y
  * allowing use by or being accommodating to people with disabilities or with limited hardware
# Americans with Disabilities Act
  * aka ADA
  * a law requiring accomodations to websites
# What You See Is What You Get
  * aka WYSIWYG
# Web Hypertext Application Technology # Working Group
  * aka WHATWG
# execute
  * synonymous with run, though of a slightly different connotation
# Software
  * executable files, bytes, or code
    * I was tricked into running malicious (Software)
# Hardware
  * physical components of a computer
# Firmware
  * A kind of (software), run directly on (hardware). Usually (Read-Only), but sometimes may be updated. Manages hardware for the operating system.
    s> I should update my BIOS firmware.
  * On certain (embedded system)s, the (Operating System), which runs on the hardware. Sometimes solely an alias for Operating System rather than (firmware:n1); 
    +> Operating System
    +> 
# print
